...
class TopicController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if (isset($_POST['Topic']) && isset($_POST['Post'])) {
            ...
            try {
                $topic_model->attributes = $_POST['Topic'];
                $post_model->attributes = $_POST['Post'];

                if ($topic_model->save()) {
                    $post_model->topic_id = $topic_model->id;
                    if ($post_model->save()) {
                        $transaction->commit();
                        $this->redirect(array('view', 'id' => $topic_model->id));
                    }
                }
                ...
                Yii::log('Exception when saving data: ' . $exc->getMessage(), CLogger::LEVEL_ERROR);
            }
        }
